...
import { CreateProductResponse } from 'src/app/models/interfaces/products/request/response/CreateProductReponse';
...
export class ProductsService {
  ...
  createProduct(requestDatas: CreateProductRequest
